          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
                Restoranınızın atmosferini doğru müziklerle zenginleştirin. Müşterilerinize unutulmaz bir yemek deneyimi
                sunun.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
              ...
              <div className="flex flex-col justify-center">
                <h2 className="text-3xl font-bold mb-6">Neden Restoran Müziği Önemli?</h2>
                <p className="text-muted-foreground leading-relaxed mb-6">
                  Doğru müzik seçimi, restoranınızın atmosferini belirleyen en önemli faktörlerden biridir.
                  Müşterilerinizin yemek deneyimini zenginleştiren, rahatlamalarını sağlayan ve tekrar gelmelerini
                  teşvik eden profesyonel müzik yayını ile fark yaratın.
                </p>
                <p className="text-muted-foreground leading-relaxed mb-8">
                  RTP Medya olarak, restoranınızın konseptine, hedef kitlenize ve günün farklı saatlerine uygun özel
